    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                ...
                <x-input id="email" class="block mt-1 w-full bg-gray-700 autofill:bg-gray-700" type="email" name="email" :value="old('email')" required autofocus />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="password" class="block mt-1 w-full bg-gray-700"
                                type="password"
                                name="password"
            ...
            <div class="block mt-4">
                <label for="remember_me" class="inline-flex items-center">
                    <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-red-700 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="remember">
